...
- [houserules.corpus-batch14-fixtures-are-committed] tests/fixtures/batch14-workspace/ commits gitignored .superpowers/ batch-14 deliverables verbatim, host paths included.
