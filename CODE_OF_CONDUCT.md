...
report a possible violation, contact the maintainer,
[@jblossey](https://github.com/jblossey), directly on GitHub.

The maintainer takes reports of violations seriously and will make every
effort to respond in a timely manner. They will investigate all reports
of code of conduct violations, reviewing messages, logs, and recordings,
or interviewing witnesses and other participants. Investigation and
enforcement actions stay as transparent as possible while prioritizing
safety and confidentiality: enforcement actions are carried out in
...
2. Temporarily Limited Activities
   ...
   2. Consequence: A private, written warning with a time-limited
      ...
      situation and give the people involved time to process the
      incident. The cooldown period may be limited to particular
...
3. Temporary Suspension
   1. Event: A pattern of repeated violation which warnings have failed
      to address, or a single serious violation.
...
4. Permanent Ban
   1. Event: A pattern of repeated code of conduct violations that
      ...
      so serious that there is no way to keep the community safe with
      this person as a member.
   2. Consequence: Access to all community spaces, tools, and
      communication channels is removed. Permanent bans should be
      rarely used, should have strong reasoning behind them, and should
      only be resorted to if working through other remedies has failed
      to change the behavior.
   3. Repair: There is no possible repair in cases of this severity.

This enforcement ladder is a guideline. It does not limit the
maintainer's discretion and judgment, in keeping with the best interests
of the community.
...
public or other spaces. Examples of representing the community include
...
at <https://www.contributor-covenant.org/translations>. The enforcement
