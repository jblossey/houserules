...
Report a security vulnerability privately, through GitHub, rather than in
a public issue: open this repository's **Security** tab and use **Report
a vulnerability**, or go directly to
...
houserules is pre-1.0 (`0.x`). Security fixes target the latest published
